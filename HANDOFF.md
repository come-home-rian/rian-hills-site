...
*Last updated: 2026-08-28 — initial project folder created at `C:\Users\moria\rian-hills-site`; v5 bundle unpacked into `index.html`; 8 brand assets extracted to `/assets` for reference.*
