...
- [x] ~~Nektar page needed a "fun" moment~~ — added an ambient honey-drip animation plus a clickable hive (3 bees fly a heart-shaped path into it on click, reusing the existing swarm/jar bee art) — done 2026-08-28. See the debugging note below; this took an unusual amount of trial-and-error and the lesson is worth reading before touching this block again.
